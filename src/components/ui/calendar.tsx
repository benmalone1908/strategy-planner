  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: "inline-flex items-center justify-center rounded-md h-7 w-7 p-0 font-normal text-[0.75rem] hover:bg-accent hover:text-accent-foreground aria-selected:opacity-100 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
